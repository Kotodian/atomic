...
func (this *LoginRequest) Validate() error {
	if !(len(this.Username) > 7) {
		return github_com_mwitkow_go_proto_validators.FieldError("Username", fmt.Errorf(`value '%v' must have a length greater than '7'`, this.Username))
	}
	if !(len(this.Username) < 13) {
		return github_com_mwitkow_go_proto_validators.FieldError("Username", fmt.Errorf(`value '%v' must have a length smaller than '13'`, this.Username))
	}
	...
	if !(len(this.Password) < 13) {
		return github_com_mwitkow_go_proto_validators.FieldError("Password", fmt.Errorf(`value '%v' must have a length smaller than '13'`, this.Password))
	}
	return nil
}
